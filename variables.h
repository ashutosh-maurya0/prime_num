...
typedef struct struct_ptr {
	...
	u_int64_t *temp_ptr_s_0;	            /* primef.c: this stores the address of "temp_ptr_0" */
...
int 
output(int argc_v_1, char *argv_v_1[], struct_ptr *argv_st);
...
/* output.c */
int temp_l_8;					/* for loop */
int temp_l_9;					/* for loop */
int check_v_6;			
